...
const langs = {
  "de": {
    'blank_page': '<variable id="blank_page">Diese Seite wurde absichtlich leer gelassen</variable>',
  ...
  "en": {
    'blank_page': '<variable id="blank_page">This page intentionally left blank</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "es": {
    'blank_page': '<variable id="blank_page">Esta página ha sido expresamente dejada en blanco</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "fi": {
    'blank_page': '<variable id="blank_page">Tämä sivu on tarkoituksellisesti jätetty tyhjäksi</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "fr": {
    'blank_page': '<variable id="blank_page">Cette page a été volontairement laissée vide</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "it": {
    'blank_page': '<variable id="blank_page">Questa pagina è stata lasciata intenzionalmente vuota</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
    "Figure": "<variable id='Figure'> Figura: <param ref-name='title'/></variable>",
  ...
  "ja": {
    'blank_page': '<variable id="blank_page">このページは計画的にブランクを残ている</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "nl": {
    'blank_page': '<variable id="blank_page">Deze bladzijde werd met opzet blanco gelaten</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "ro": {
    'blank_page': '<variable id="blank_page">Aceasta pagina a fost lasata libera in mod intentionat</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "ru": {
    'blank_page': '<variable id="blank_page">Эта страница нарочно оставлена пустой</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "sl": {
    'blank_page': '<variable id="blank_page">Tale stran je zanalačš pučšena prazna</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
  ...
  "sv": {
    'blank_page': '<variable id="blank_page">Denna sida har avsiktligen lämnats blank</variable>',
    "#table-continued": "<variable id='#table-continued'>Table continued&#x2026;</variable>",
...
function generate_vars(lang, options) {
  ...
  if (!(_.has(options.style["link"], "link-page-number") && options.style["link"]["link-page-number"] === true)) {
  ...
  if (_.has(options.style["table"], "caption-number") && options.style["table"]["caption-number"] === "none") {
    root.append(ET.parse(langs[lang]["Table"]).getroot())
  }
  // figure caption numbering
  if (_.has(options.style["fig"], "caption-number") && options.style["fig"]["caption-number"] === "none") {
    root.append(ET.parse(langs[lang]["Figure"]).getroot())
  }
  // chapter numbering
  if (_.has(options.style["topic"], "title-numbering") && options.style["topic"]["title-numbering"] !== true) {
  ...
  if (options.cover_image_name) {
    ET.SubElement(root, "variable", {id: "cover-image-path"}).text = `Customization/OpenTopic/common/artwork/${options.cover_image_name}"`
  }
  // blank page
  ...
  _.range(1, 5).forEach((level) => {
    ...
    if (_.has(options.style, "ol") && _.has(options.style["ol"], `ol-before-${level}`)) {
    ...
    if (_.has(options.style, "ol") && _.has(options.style["ol"], `ol-after-${level}`)) {
  ...
  _.range(1, 5).forEach((level) => {
    ...
    if (_.has(options.style, "ol") && _.has(options.style["ol"], `ol-${level}`)) {
  ...
  _.range(1, 5).forEach((level) => {
    ...
    if (_.has(options.style, "ul") && _.has(options.style["ul"], `ul-${level}`)) {
