...
function generate_custom_attr(root, conf) {
  ...
  conf.attribute_set(root, 'toc_1', '__toc__topic__content', _.difference(conf.properties, ["start-indent"]))
  //conf.attribute_set(root, 'toc_1', '__toc__topic__content_1', _.difference(conf.properties, ["start-indent"]), '__toc__topic__content')
  conf.attribute_set(root, 'toc_2', '__toc__topic__content_2', _.difference(conf.properties, ["start-indent"]), '__toc__topic__content')
  conf.attribute_set(root, 'toc_3', '__toc__topic__content_3', _.difference(conf.properties, ["start-indent"]), '__toc__topic__content')
  conf.attribute_set(root, 'toc_4', '__toc__topic__content_4', _.difference(conf.properties, ["start-indent"]), '__toc__topic__content')

  conf.attribute_set(root, 'toc_1', '__toc__chapter__content', _.difference(conf.properties, ["start-indent"]))
  conf.attribute_set(root, 'toc_1', '__toc__appendix__content', _.difference(conf.properties, ["start-indent"]))
  conf.attribute_set(root, 'toc_1', '__toc__part__content', _.difference(conf.properties, ["start-indent"]))
  conf.attribute_set(root, 'toc_1', '__toc__preface__content', _.difference(conf.properties, ["start-indent"]))
  conf.attribute_set(root, 'toc_1', '__toc__notices__content', _.difference(conf.properties, ["start-indent"]))
  conf.attribute_set(root, 'toc_1', '__toc__topic__content__booklist', _.difference(conf.properties, ["start-indent"]))
}
