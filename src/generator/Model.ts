...
function getHeaderFooterDefault(content: Autogenerated[]): HeaderFooter {
  return {
    ...Object.fromEntries(
...
export function getInitStore(): PluginModel {
  return {
    ...
    header: {
      odd: getHeaderFooterDefault([Autogenerated.TITLE]),
      even: getHeaderFooterDefault([Autogenerated.TITLE]),
    },
    footer: {
      odd: getHeaderFooterDefault([Autogenerated.FOLIO]),
      even: getHeaderFooterDefault([Autogenerated.FOLIO]),
    },
    style: getInitStyle(),
