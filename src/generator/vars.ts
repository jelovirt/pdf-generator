...
import { CustomProperty, FoProperty } from './styles';
...
export default function generate_vars(lang: Language, options: Generator) {
  ...
  _.range(1, 5).forEach((level) => {
    ...
    if (
      ...
      options.style['ol'][olBeforeField] !== undefined
    ) {
  ...
  _.range(1, 5).forEach((level) => {
    ...
    if (
      options.style['ol'] !== undefined &&
      options.style['ol'][olField] !== undefined
    ) {
  ...
  _.range(1, 5).forEach((level) => {
    ...
    if (
      options.style['ul'] !== undefined &&
      options.style['ul'][ulLevel] !== undefined
    ) {
